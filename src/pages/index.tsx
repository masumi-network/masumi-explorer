  ...
  return (
    <div>
      <div className="flex flex-col gap-4 mb-7">
        ...
        <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-lg border border-blue-200/20">
          <div className="flex-1">
            <h2 className="font-medium mb-1">About Masumi Registry</h2>
